...
.. uc:: Create user account
   ...
   User creates a new account to access synchronization and cloud features.
...
.. uc:: Use application offline
   :id: UC-1_4
   :status: open
   :priority: P0
   :actors: Anonymous User, Registered User
   :links: FR-1_4;NFR-2_1

   User accesses application without internet connection.
...
.. uc:: Recover password
   ...
   User resets forgotten password via email.
...
.. uc:: Delete account
   ...
   User permanently deletes their account and all data.
   ...
   *A1: Export data first*
   ...
   - See :need:`UC-2_7` for export process
...
.. uc:: Import book files
   ...
   User adds books to library from files.
...
.. uc:: Convert book formats
   ...
   User converts book to different format.
...
.. uc:: Edit book metadata
   :id: UC-2_3
   :status: open
   :priority: P0
   :actors: Reader
   :links: FR-2_2;FR-2_13

   User modifies book information.
...
.. uc:: Organize books into shelves
   :id: UC-2_4
   :status: open
   :priority: P0
   :actors: Reader
   ...
   User creates and manages book collections.
...
.. uc:: Tag books
   ...
   User assigns colored labels to books.
...
.. uc:: Search books
   ...
   :priority: P0
   :actors: Reader
   :links: FR-2_7;FR-2_8;FR-2_11

   User finds books using search and filters.
...
.. uc:: Export books and data
   ...
   User exports library data for backup or migration.
...
.. uc:: Scan ISBN barcode
   ...
   User adds physical book by scanning barcode.
...
.. uc:: Track physical book
   ...
   User manages physical books in library.
...
.. uc:: Read books with integrated viewer
   :id: UC-3_1
   :status: open
   :priority: P0
   ...
   User reads e-books in the viewer.
...
.. uc:: Customize reading experience
   :id: UC-3_2
   :status: open
   :priority: P0
   :actors: Reader, E-ink Reader
   ...
   User personalizes viewer appearance.
...
.. uc:: Manage reading profiles
   ...
   User saves and switches reader configurations.
...
.. uc:: Manage bookmarks
   ...
   User creates and uses bookmarks.
...
.. uc:: Create text annotations
   ...
   User highlights text while reading.
...
.. uc:: Create book notes
   ...
   User creates free-form notes for books.
...
.. uc:: Manage annotations
   ...
   User edits or deletes annotations.
...
.. uc:: Export annotations
   ...
   User exports annotations to file.
...
.. uc:: Search annotations
   ...
   User searches through annotations.
...
.. uc:: Track reading progress
   ...
   System tracks and displays reading activity.
...
.. uc:: Filter progress statistics
   ...
   User customizes statistics view.
...
.. uc:: Manage goal progress
   ...
   User and system update goal progress.
...
.. uc:: Configure storage options
   :id: UC-7_1
   :status: open
   :priority: P0
   :actors: Registered User, System Administrator
   :links: FR-7_1;FR-7_1_1

   User configures metadata server connection and file storage backend(s) for synchronization and book storage.
   ...
   **Postconditions:**
   ...
   See :doc:`/design/server-architecture` for technical details.

.. uc:: Process scanned documents
   :id: UC-7_2
   :status: open
   :priority: P2
   :actors: Reader
   ...
   System applies OCR to scanned books.
...
.. uc:: Synchronize data across devices
   :id: UC-7_3
   :status: open
   :priority: P0
   :actors: Registered User
   :links: FR-5_3;NFR-2_1

   System keeps metadata, reading progress, and annotations consistent across devices via the metadata server.
...
.. uc:: Browse OPDS catalog
   ...
   User downloads books from online catalogs.
