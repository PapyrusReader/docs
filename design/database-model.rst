...
This section presents the database schema for Papyrus, showing table
structures, relationships, constraints, and design principles.
...
+--------------------------------+-------------------------------------+
| **Configuration**              | READING_PROFILE,                    |
|                                | METADATA_SERVER_CONFIG,             |
|                                | FILE_STORAGE_BACKEND, SAVED_FILTER  |
+--------------------------------+-------------------------------------+
...
Stores the user’s connection to a metadata server for cross-device
synchronization. Each user has at most one configuration.
...
Stores configurations for file storage backends. Users can have multiple
backends configured.
